...
window.addEventListener("DOMContentLoaded", async (): Promise<void> => {
  ...
  document.body.querySelector("#setPAT").addEventListener("click", (): void => {
  ...
  document.body.querySelector("#checkPAT").addEventListener("click", (): void => {
  ...
  document.body.querySelector("#clearPAT").addEventListener("click", (): void => {
  ...
  function registerCommand(selector: string, fn): void {
    ...
    commandElem.addEventListener("click", (): void => {
